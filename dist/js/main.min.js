...
document.querySelectorAll('.choice').forEach(el => {
  let choices = new choices_js__WEBPACK_IMPORTED_MODULE_0__(el, {
    searchEnabled: false,
    position: 'auto',
    itemSelectText: '',
    shouldSort: false,
...
/* harmony export */   "isShadow": () => (/* binding */ isShadow),
...
function customModal() {
  document.querySelectorAll('.positions-item__btn').forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      const title = btn.closest('li').querySelector('.positions-item__title').innerHTML;
...
if (heroSlider) {
  const SwiperHeroSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](heroSlider, {
...
if (testiSlider) {
  const testimonialsSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](testiSlider, {
...
if (proSlider) {
  const projectsSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](proSlider, {
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Keyboard],
    slidesPerView: 3,
    spaceBetween: gap,
    loop: true,
...
if (workSlider) {
  const SwiperWorkThumbs = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.work-slider-nav', {
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation],
    spaceBetween: 20,
    slidesPerView: 6,
    freeMode: true,
  ...
  const SwiperWork = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](workSlider, {
...
if (historySlider) {
  const swiperHistory = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](historySlider, {
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Keyboard],
    simulateTouch: false,
    speed: 1000,
    slidesPerView: 1,
  ...
  swiperHistory.on('slideChange', function () {
    ...
    document.querySelector(`.history-nav__btn[data-index="${swiperHistory.realIndex}"]`).classList.add('history-nav__btn--active');
  });
...
/* harmony import */ var _modules_choices_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/choices.js */ "./src/js/modules/choices.js");


// import './modules/progress.js'
// import './modules/accordions.js'
// import './modules/portfolio-tabs.js'

// import './modules/video.js'
// import './modules/to-top.js'
// import './modules/modal.js'

_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.isTab();
_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.isScroll();
_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.isVideo();
_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.isModal();
_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.isAccordion();
_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.customModal();
_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.FileChange();
_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.DisableField();
_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.isShadow();
_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.progress();
})();
